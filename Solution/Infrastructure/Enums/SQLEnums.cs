...
namespace Infrastructure.Enums
{
    public static class SQLEnums
    {
        ...
        public enum StoredProcedureNames
        {
            ...
            ТипыЗаявокДобавить, РазрешенияРолейДобавить, УслугиДобавить,
            ДопинфоДобавить, КлиентыДобавить, ДолжностиИзменить,
            ЗаявкиИзменить, СотрудникиИзменить, ТипыЗаявокИзменить,
            УслугиИзменить, ДопинфоИзменить, КлиентыИзменить,
            ЛидДобавить, ПереносКлиентаВАрхив, УдалитьПустыеДопИнфо,
            ОбнулитьПустыеДопИнфоКлиентов, СписокРазрешенийДляРоли, РазрешенияРолейУдалить,
